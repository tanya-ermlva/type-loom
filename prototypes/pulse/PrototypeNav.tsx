/**
 * PrototypeNav — header dropdown for switching between Atom / Stack / Polotno views.
 *
 * Lives in pulse/ so both pulse and stack can import it via relative path.
 * Each entry knows its URL (relative to /prototypes/) and whether it's clickable.
 * Disabled entries appear greyed-out as "coming soon" placeholders.
 */
...
const ENTRIES: Entry[] = [
  { view: 'atom',    label: 'Atom',    href: '../pulse/' },
  { view: 'stack',   label: 'Stack',   href: '../stack/' },
